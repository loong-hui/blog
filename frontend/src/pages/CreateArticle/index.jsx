...
import { getArticleInfo, addArticleTag, removeArticleTag, createArticleAboutError, removeUseless } from "../../store/modules/articleSlice";
...
const CreateArticle = () => {
    ...
    const createSubmit = async (e, article) => {
        e.preventDefault();
        try {
            let result = await request.article.create(article);
            // console.log(result);
            if (result.status == 1) {
                ...
                <div className="row">
                    <div className="col-md-6 offset-md-3 col-xs-12">
                        ...
                        <form>
                            ...
                            <button className="btn btn-success" onClick={(e) => createSubmit(e, { title, description, body, tag, tags },)}>发布文章</button>
                        </form>
                    </div>
                </div>
            </div>
